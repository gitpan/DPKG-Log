# This Makefile is for the DPKG::Log extension to perl.
#
...
#     ABSTRACT => q[Parse and analyse dpkg log files]
#     AUTHOR => q[Patrick Schoenfeld <schoenfeld@debian.org>]
#     BUILD_REQUIRES => {  }
#     DISTNAME => q[DPKG-Log]
#     LICENSE => q[perl]
...
INST_LIBDIR      = $(INST_LIB)/DPKG
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/DPKG
...
TO_INST_PM = lib/DPKG/Log.pm \
	lib/DPKG/Log/Analyse.pm \
	lib/DPKG/Log/Analyse/Package.pm \
	lib/DPKG/Log/Entry.pm

PM_TO_BLIB = lib/DPKG/Log.pm \
	blib/lib/DPKG/Log.pm \
	lib/DPKG/Log/Entry.pm \
	blib/lib/DPKG/Log/Entry.pm \
	lib/DPKG/Log/Analyse/Package.pm \
	blib/lib/DPKG/Log/Analyse/Package.pm \
	lib/DPKG/Log/Analyse.pm \
	blib/lib/DPKG/Log/Analyse.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/DPKG/Log.pm $(INST_MAN3DIR)/DPKG::Log.$(MAN3EXT) \
	  lib/DPKG/Log/Entry.pm $(INST_MAN3DIR)/DPKG::Log::Entry.$(MAN3EXT) \
	  lib/DPKG/Log/Analyse/Package.pm $(INST_MAN3DIR)/DPKG::Log::Analyse::Package.$(MAN3EXT) \
	  lib/DPKG/Log/Analyse.pm $(INST_MAN3DIR)/DPKG::Log::Analyse.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/DPKG/Log.pm blib/lib/DPKG/Log.pm \
	  lib/DPKG/Log/Entry.pm blib/lib/DPKG/Log/Entry.pm \
	  lib/DPKG/Log/Analyse/Package.pm blib/lib/DPKG/Log/Analyse/Package.pm \
	  lib/DPKG/Log/Analyse.pm blib/lib/DPKG/Log/Analyse.pm 
